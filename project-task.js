...
console.log(
  `The sum of ${number1} and ${number2} is ${sumOfTwoNumbers(number1, number2)}`,
);

// Script 3
let productOfTwoNumbers = function (val1, val2) {
  return val1 * val2;
};
console.log(
  `The product of ${number1} and ${number2} is ${productOfTwoNumbers(number1, number2)}`,
);
